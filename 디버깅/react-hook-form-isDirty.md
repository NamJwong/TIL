...
아니 근데 그러면 defaultValues는 모든 값을 채우도록 타입으로 강제해야 하는 거 아니야?

isDirty와 defaultValues가 관계있을 거라고 그 문서의 한마디를 읽고 예상하기가 어려울 것 같은데..?

isDirty가 필요 없는데 defaultValues를 자유롭게 쓰고 싶은 개발자들을 고려한 건가

아무래도 라이브러리는 사용 방식에 제약이 없을수록 좋으니까..?
